...
//         //         if (!rulesChannel) { language(message, 'UNKWN_ERR'); return }
...
//         //         if (!cekarnaVoiceChannel) { language(message, 'UNKWN_ERR'); return }
//         //     }
//         //     else if (output.id === 1) {
//         //         //mention it
...
//         //         if (!cekarnaTextChannel) { language(message, 'UNKWN_ERR'); return }
//         //     }
//         //     else if (output.id === 1) {
//         //         //mention it
...
//     var textInputOutput = await textInput(message, output.botMessage, 'Setup - Role hierarchy', 'Mention all roles that are used for giving different permissions on your server, excluding bot roles (role hierarchy) in ascending order of importance (example input: @Basic @VIP @Mod @Owner)', null)
//     var steps: Step[] | null = []
//     while (true) {
...
//             break
//         }
//         var textInputOutput = await textInput(message, output.botMessage, 'Setup - Role hierarchy', 'Mention all roles that are used for giving different permissions on your server, excluding bot roles (role hierarchy) in ascending order of importance (example input: @Basic @VIP @Mod @Owner)\n Error, try again!', null)
//     }
//     return steps
